...
<p align="center">
  ...
  <a href="docs/api/operations-guide.md">API Guide</a> |
...
- An administrator profile with avatar, display nickname, login username, and a direct account-settings shortcut.
