"""add image enhancement tasks

Revision ID: 0008_image_enhancement_tasks
Revises: 0007_admin_sessions
...
revision: str = "0008_image_enhancement_tasks"
down_revision: str | None = "0007_admin_sessions"
